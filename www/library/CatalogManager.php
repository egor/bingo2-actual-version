            ...
            if (!empty($sectionName)) {
                ...
                if (!empty($sectionName)) {
                    ...
                    if (isset($existsTablesArray[$sectionArtikul])) {
                        ...
                        $isTableExistsTmp = $this->isTableExists("catalog-fields-$sectionArtikul") ;
                        if ($isTableExistsTmp && ($userDataId = $this->db->fetchOne("SELECT `id` FROM `catalog-fields-$sectionArtikul` WHERE `catalog_artikul`='$artikul'"))) {
                            $this->db->update('catalog-fields-' . $sectionArtikul, $data1, "id=$userDataId");
                        } elseif ($isTableExistsTmp) {
