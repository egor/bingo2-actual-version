...
var _gaq = _gaq || []; 
_gaq.push (['_setAccount', 'UA-32641686-1']); 
...
_gaq.push (['_addOrganic', 'quintura.com','request']);
_gaq.push (['_addOrganic', 'ru.yahoo.com', 'p']);
_gaq.push (['_addOrganic', 'search.livetool.ru', 'text']);
_gaq.push (['_addOrganic', 'yandex.03compu.ru', 'query']);
_gaq.push (['_trackPageview']); 
(function() { 
var ga = document.createElement('script'); ga.type = 'text/javascript'; ga.async = true; 
ga.src = ('https:' == document.location.protocol ? 'https://ssl' : 'http://www') + '.google-analytics.com/ga.js'; 
...
(function (d, w, c) {
    (w[c] = w[c] || []).push(function() {
        try {
            w.yaCounter15278890 = new Ya.Metrika({id:15278890, enableAll: true, webvisor:true});
        } catch(e) {}
    });
...
<noscript><div><img src="//mc.yandex.ru/watch/15278890" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
