var tinyMCE_GZ = {
	settings : {
		...
		plugins : 'imagemanager,filemanager,safari,layer,table,advhr,advimage,advlink,preview,zoom,media,contextmenu,paste,directionality,noneditable,visualchars,nonbreaking',
		languages : 'ru,en',
		disk_cache : true,
