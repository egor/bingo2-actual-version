<?php
       ...
       // $mcFileManagerConfig['general.plugins'] = "History,Favorites"; // comma seperated
        ...
        $mcFileManagerConfig['download.extensions'] = "gif,jpg,htm,html,pdf,txt,zip,swf";
        ...
        $mcFileManagerConfig['authenticator.login_page'] = "/404";
        $mcFileManagerConfig['authenticator.allow_override'] = "*";

        // SessionAuthenticator
        $mcFileManagerConfig['SessionAuthenticator.logged_in_key'] = $_SESSION['userData']['logged'];
